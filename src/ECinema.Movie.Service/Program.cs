...
using ECinema.Movie.Service.Application.Movies.Commands.Create;
using ECinema.Movie.Service.Application.Movies.Commands.Update;
using ECinema.Movie.Service.Data;
using ECinema.Movie.Service.Models.Movies;
using MediatR;
